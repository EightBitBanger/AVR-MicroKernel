...
void kInit(void) {
    ...
    uint8_t dirNameTest[] = "test";
    uint32_t dirTestAddress = fsDirectoryCreate(dirNameTest, sizeof(dirNameTest));
    ...
    fsDirectoryAddFile(fsWorkingDirectoryGetAddress(), dirTestAddress);
