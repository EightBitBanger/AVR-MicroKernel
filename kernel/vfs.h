...
struct VirtualFileSystemInterface {
    ...
    int32_t(*open)(uint8_t*);                       // Open or create a file
    ...
    uint8_t(*chdir)(uint8_t*);                      // Change directory
    uint8_t(*mkdir)(uint8_t*);                      // Create directory
    uint8_t(*rmdir)(uint8_t*);                      // Remove directory
    
    uint8_t(*unlink)(uint8_t*);                     // Deletes file
